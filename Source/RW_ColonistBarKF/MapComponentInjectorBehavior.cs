...
{       // This code is mostly borrowed from Pawn State Icons mod by Dan Sadler, which has open source and no license I could find, so...
    ...
    public class MapComponentInjectorBehavior : MonoBehaviour
    {
        ...
        private static readonly RW_ColonistBarKF.MapComponent_FollowMe mapComponent = new RW_ColonistBarKF.MapComponent_FollowMe();       // Ditto.
        ...
        public void FixedUpdate()
        {
            ...
            if (reinjectNeeded)
            {
                Log.Message("FollowMeInjector - needs reinject");
