...
namespace ColonistBarKF
{
...
#endif
    {
        ...
        public override Vector2 InitialSize => new Vector2(520f, 690f);
                ...
                case 1:
                    {
                        ...
                        BeginHorizontal();
                        FlexibleSpace();
                        PSIToolbarInt = SelectionGrid(PSIToolbarInt, psiToolbarStrings, Mathf.FloorToInt(viewRect.width / 150));
                        FlexibleSpace();
                        EndHorizontal();
